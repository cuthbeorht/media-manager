...
def test_given_valid_path_with_music_walk_expect_valid_number_of_files(media_root: Path, songs_in_fixtures: int):
...
def test_given_valid_path_with_music_walk_expect_valid_media_file_data(media_root: Path, songs_in_fixtures: int):
    ...
    assert "test/fixtures/media/desifreemusic-creative-commons-music-free-download-and-safe-for-monetization-364593.mp3" in str(service.media_files[0].full_file_name)